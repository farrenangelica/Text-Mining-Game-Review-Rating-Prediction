...
| TF-IDF              | XGBoost             | XX       | XX        | XX     | XX       |
| Word2Vec            | Logistic Regression | XX       | XX        | XX     | XX       |
| Word2Vec            | XGBoost             | XX       | XX        | XX     | XX       |

> Replace the values above with the final results obtained from the notebook.
